...
namespace Presentacion {
	...
	/// <summary>
	/// Summary for FrmVendedor
	/// </summary>
	public ref class FrmVendedor : public System::Windows::Forms::Form
	{
	public:
		FrmVendedor(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox2->Text = L"Listado de Vendedores";
			// 
			// btnEliminar
			// 
			...
			this->btnEliminar->Click += gcnew System::EventHandler(this, &FrmVendedor::btnEliminar_Click);
			// 
			// btnBuscar
			// 
			...
			this->btnBuscar->Click += gcnew System::EventHandler(this, &FrmVendedor::btnBuscar_Click);
			// 
			// txtBuscar
			// 
			...
			this->txtBuscar->TextChanged += gcnew System::EventHandler(this, &FrmVendedor::txtBuscar_TextChanged);
			// 
			// label8
			// 
			...
			this->dgvListado->CellDoubleClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &FrmVendedor::dgvListado_CellDoubleClick);
			// 
			// btnRegistrar
			// 
			...
			this->btnRegistrar->Click += gcnew System::EventHandler(this, &FrmVendedor::btnRegistrar_Click);
			// 
			// btnCancelar
			// 
			...
			this->btnCancelar->Click += gcnew System::EventHandler(this, &FrmVendedor::btnCancelar_Click);
			// 
			// btnActualizar
			// 
			...
			this->btnActualizar->Click += gcnew System::EventHandler(this, &FrmVendedor::btnActualizar_Click);
			// 
			// label7
			// 
			...
			this->groupBox1->Text = L"Mantenimiento de Vendedores";
			// 
			// txtSueldo
			// 
			this->txtSueldo->Location = System::Drawing::Point(99, 401);
			this->txtSueldo->Name = L"txtSueldo";
			this->txtSueldo->Size = System::Drawing::Size(171, 26);
			this->txtSueldo->TabIndex = 18;
			// 
			// label9
			// 
			this->label9->AutoSize = true;
			this->label9->Location = System::Drawing::Point(14, 404);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(63, 20);
			this->label9->TabIndex = 17;
			this->label9->Text = L"Sueldo:";
			// 
			// FrmVendedor
			// 
			...
			this->Name = L"FrmVendedor";
			this->Text = L"Vendedor";
			this->Load += gcnew System::EventHandler(this, &FrmVendedor::FrmVendedor_Load);
...
private: System::Void listar() {
	...
	dt->Columns->Add("Sueldo", System::Type::GetType("System.Decimal"));
	dgvListado->DataSource = dt;

	while (cuantos == SIZEVENDEDOR) {
		if (vendedor.getCodigoVendedor() > 0) {
			vendedor.verVendedor(dt);
		}
		archivo.read((char*)&vendedor, SIZEVENDEDOR);
...
private: System::Void FrmVendedor_Load(System::Object^ sender, System::EventArgs^ e) {
	listar();
}
...
private: System::Void btnRegistrar_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	archivo.open("../Archivos/vendedor.dat", ios::app | ios::binary);

	vendedor.registrarVendedor(cantidadRegistros() + 1, txtDni->Text, txtNombre->Text, txtDireccion->Text, txtTelefono->Text, txtCelular->Text, txtCorreo->Text, (float)Convert::ToDecimal(txtSueldo->Text));
	archivo.write((char*)&vendedor, SIZEVENDEDOR);
	txtCodigo->Text = Convert::ToString(cantidadRegistros() + 1);
	MessageBox::Show("Registro exitoso");
	MessageBox::Show("Usuario: " + vendedor.getUsuario() + "\nContraseña: " + vendedor.getContrasenia());
	limpiar();
	archivo.close();
	listar();
}
...
private: System::Void btnBuscar_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	bool find = false;
	while (cuantos == SIZEVENDEDOR) {
		if (vendedor.buscarVendedor(txtBuscar->Text) && vendedor.getCodigoVendedor() > 0) {
			vendedor.verVendedor(dt);
			find = true;
			break;
		}
	...
	if (find == false) {
		MessageBox::Show("El numero de DNI del vendedor ingresado no existe");
	}
...
private: System::Void dgvListado_CellDoubleClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
	...
	txtSueldo->Text = Convert::ToString(dgvListado->CurrentRow->Cells["Sueldo"]->Value);
...
private: System::Void btnActualizar_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	archivo.open("../Archivos/vendedor.dat", ios::in | ios::out | ios::binary);

	vendedor.actualizarVendedor(Convert::ToInt32(txtCodigo->Text), txtDni->Text, txtNombre->Text, txtDireccion->Text, txtTelefono->Text, txtCelular->Text, txtCorreo->Text, (float)Convert::ToDecimal(txtSueldo->Text));
	archivo.seekg((Convert::ToInt32(txtCodigo->Text) - 1) * SIZEVENDEDOR, ios::beg);
	archivo.write((char*)&vendedor, SIZEVENDEDOR);
...
private: System::Void btnEliminar_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	archivo.seekg((codigo - 1) * SIZEVENDEDOR, ios::beg);
	archivo.write((char*)&vendedor, SIZEVENDEDOR);
